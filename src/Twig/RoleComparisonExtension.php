...
class RoleComparisonExtension extends AbstractExtension
{
    ...
    public function compareRoles(array $currentUserRoles, array $otherUserRoles): bool
    {
        ...
        $rolesHierarchy = [
            'ROLE_SUPER_ADMIN' => ['ROLE_MASTER_ADMIN', 'ROLE_VALIDATOR', 'ROLE_ADMIN', 'ROLE_LINE_ADMIN', 'ROLE_MANAGER', 'ROLE_USER'],
            'ROLE_MASTER_ADMIN' => ['ROLE_ADMIN', 'ROLE_LINE_ADMIN_VALIDATOR', 'ROLE_LINE_ADMIN', 'ROLE_MANAGER', 'ROLE_USER'],
