...
sed -i "s|^# DATABASE_URL=.*|DATABASE_URL=mysql://root:\${MYSQL_ROOT_PASSWORD}@docauposte-database-pod/\${MYSQL_DATABASE}?charset=utf8mb4&serverVersion=11.4.5-MariaDB&sslmode=verify_ca&sslrootcert=/etc/ssl/certs/ca-cert.pem|" .env;
