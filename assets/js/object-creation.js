...
// This line declares a variable named projectsData without assigning it a value.
...
function initCascadingDropdowns() {
  ...
  if (department) {
    ...
    populateDropdown(department, projectsData);
  ...
  if (validatorDepartment) {
    // Populate the department dropdown with data
    populateDropdown(validatorDepartment, projectsData);
...
// If the dropdown exists, it calls the populateDropdown() function to populate the department dropdown with the projectsData. 
...
// Once the data is successfully received, it assigns the departments property of the data to the projectsData variable. 
...
function createNewSelect(selectedValue, selectId) {
  ...
  if (selectedValue !== '') {
    ...
    if (document.querySelectorAll('.departmentSelect').length < projectsData.length) {
      createSelectElement();
    }
  }
}
...
function createSelectElement() {
  ...
  // Iterate over each department in the projectsData array
  projectsData.forEach(function (department) {
